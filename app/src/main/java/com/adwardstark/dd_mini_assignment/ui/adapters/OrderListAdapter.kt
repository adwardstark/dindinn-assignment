...
import com.adwardstark.dd_mini_assignment.databinding.LayoutOrderItemLandBinding
...
class OrderListAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if(isPortrait) {
            OrderItemViewHolder(LayoutOrderItemBinding
                .inflate(LayoutInflater.from(parent.context), parent, false))
        } else {
            OrderItemViewHolderLandscape(LayoutOrderItemLandBinding
                .inflate(LayoutInflater.from(parent.context), parent, false))
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if(isPortrait) {
            (holder as OrderItemViewHolder).bind(currentList()[position])
        } else {
            (holder as OrderItemViewHolderLandscape).bind(currentList()[position])
        }
    }
    ...
    inner class OrderItemViewHolderLandscape(private val viewBinder: LayoutOrderItemLandBinding)
        : RecyclerView.ViewHolder(viewBinder.root) {
